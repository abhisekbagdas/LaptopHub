...
<body>
<main class="error-page" role="main" aria-labelledby="error-title" style="margin-top: 250px">
    <div class="error-container">
        <div class="scene-wrap" tabindex="0" aria-labelledby="error-title">
            <div class="error-content">
                <img src="${pageContext.request.contextPath}/static/images/Error/JackFor400.png" alt="Jack for 400 Error" class="error-image">
